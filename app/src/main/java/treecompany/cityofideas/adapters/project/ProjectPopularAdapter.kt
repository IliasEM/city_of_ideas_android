...
class ProjectPopularAdapter(private var context: Context?, private var projects: Array<Project>) :
    RecyclerView.Adapter<ProjectPopularAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val v = LayoutInflater.from(p0.context).inflate(R.layout.list_project_pop_rec_layout, p0, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        p0.project_image.setImageResource(
            context!!.resources.getIdentifier(
                splitImagePath(project.image),
                "drawable",
                context!!.packageName
            )
        )
